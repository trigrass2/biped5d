...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2.clicked.connect(MainWindow.climbot5d)
        self.pushButton.clicked.connect(MainWindow.biped5d)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.pushButton.setText(_translate("MainWindow", "5-DOF爬臂机器人"))
        self.pushButton_2.setText(_translate("MainWindow", "5-DOF双手爪攀爬机器人"))
